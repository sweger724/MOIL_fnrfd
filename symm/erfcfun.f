      subroutine erfcfun(x,xerfc)
c this subroutine calls NETLIB complementary error function: see CALERF

      double precision x,xerfc
      integer j

      j = 1
c for error function j = 0

      call calerf(x,xerfc,j)
