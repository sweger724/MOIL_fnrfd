...
c	trickes with scalar products due 
c	to T.Schlick, J.Comput.Chem, vol 10, 7 (1989) 
c	with local variant (no delta funcion involved)

	integer namel,level
	character*7 name
	double precision phi,delta,pi,scalar1,scalar2,sinphi
...
C OFF DIAGGONAL SECOND DERIVATIVE MATRIX ELEMENTS

		iiphi = 54*(iphi-1)+1

c kl
		d2imp(iiphi) = scalar1*cokx*colx + scalar2*cokxlx
		d2imp(iiphi+1) = scalar1*coky*colx + scalar2*cokylx
		d2imp(iiphi+2) = scalar1*cokz*colx + scalar2*cokzlx
		d2imp(iiphi+3) = scalar1*cokx*coly + scalar2*cokxly
		d2imp(iiphi+4) = scalar1*coky*coly + scalar2*cokyly
		d2imp(iiphi+5) = scalar1*cokz*coly + scalar2*cokzly
		d2imp(iiphi+6) = scalar1*cokx*colz + scalar2*cokxlz
		d2imp(iiphi+7) = scalar1*coky*colz + scalar2*cokylz
		d2imp(iiphi+8) = scalar1*cokz*colz + scalar2*cokzlz
c km
		d2imp(iiphi+9) = scalar1*cokx*comx + scalar2*cokxmx
		d2imp(iiphi+10) = scalar1*coky*comx + scalar2*cokymx
		d2imp(iiphi+11) = scalar1*cokz*comx + scalar2*cokzmx
		d2imp(iiphi+12) = scalar1*cokx*comy + scalar2*cokxmy
		d2imp(iiphi+13) = scalar1*coky*comy + scalar2*cokymy
		d2imp(iiphi+14) = scalar1*cokz*comy + scalar2*cokzmy
		d2imp(iiphi+15) = scalar1*cokx*comz + scalar2*cokxmz
		d2imp(iiphi+16) = scalar1*coky*comz + scalar2*cokymz
		d2imp(iiphi+17) = scalar1*cokz*comz + scalar2*cokzmz

c kn
		d2imp(iiphi+18) = scalar1*cokx*conx + scalar2*cokxnx
		d2imp(iiphi+19) = scalar1*coky*conx + scalar2*cokynx
		d2imp(iiphi+20) = scalar1*cokz*conx + scalar2*cokznx
		d2imp(iiphi+21) = scalar1*cokx*cony + scalar2*cokxny
		d2imp(iiphi+22) = scalar1*coky*cony + scalar2*cokyny
		d2imp(iiphi+23) = scalar1*cokz*cony + scalar2*cokzny
		d2imp(iiphi+24) = scalar1*cokx*conz + scalar2*cokxnz
		d2imp(iiphi+25) = scalar1*coky*conz + scalar2*cokynz
		d2imp(iiphi+26) = scalar1*cokz*conz + scalar2*cokznz

c lm
		d2imp(iiphi+27) = scalar1*colx*comx + scalar2*colxmx
		d2imp(iiphi+28) = scalar1*coly*comx + scalar2*colymx
		d2imp(iiphi+29) = scalar1*colz*comx + scalar2*colzmx
		d2imp(iiphi+30) = scalar1*colx*comy + scalar2*colxmy
		d2imp(iiphi+31) = scalar1*coly*comy + scalar2*colymy
		d2imp(iiphi+32) = scalar1*colz*comy + scalar2*colzmy
		d2imp(iiphi+33) = scalar1*colx*comz + scalar2*colxmz
		d2imp(iiphi+34) = scalar1*coly*comz + scalar2*colymz
		d2imp(iiphi+35) = scalar1*colz*comz + scalar2*colzmz
c ln
		d2imp(iiphi+36) = scalar1*colx*conx + scalar2*colxnx
		d2imp(iiphi+37) = scalar1*coly*conx + scalar2*colynx
		d2imp(iiphi+38) = scalar1*colz*conx + scalar2*colznx
		d2imp(iiphi+39) = scalar1*colx*cony + scalar2*colxny
		d2imp(iiphi+40) = scalar1*coly*cony + scalar2*colyny
		d2imp(iiphi+41) = scalar1*colz*cony + scalar2*colzny
		d2imp(iiphi+42) = scalar1*colx*conz + scalar2*colxnz
		d2imp(iiphi+43) = scalar1*coly*conz + scalar2*colynz
		d2imp(iiphi+44) = scalar1*colz*conz + scalar2*colznz
c mn
		d2imp(iiphi+45) = scalar1*comx*conx + scalar2*comxnx
		d2imp(iiphi+46) = scalar1*comy*conx + scalar2*comynx
		d2imp(iiphi+47) = scalar1*comz*conx + scalar2*comznx
		d2imp(iiphi+48) = scalar1*comx*cony + scalar2*comxny
		d2imp(iiphi+49) = scalar1*comy*cony + scalar2*comyny
		d2imp(iiphi+50) = scalar1*comz*cony + scalar2*comzny
		d2imp(iiphi+51) = scalar1*comx*conz + scalar2*comxnz
		d2imp(iiphi+52) = scalar1*comy*conz + scalar2*comynz
		d2imp(iiphi+53) = scalar1*comz*conz + scalar2*comznz
