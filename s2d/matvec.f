...
c
	  ...
	  ii = 3*(i-1)+1
	  jj = 3*(j-1)+1
	  vectmp(ii) = vectmp(ii) + d2nb_1(kk)*vector(jj) +
     1	  	d2nb_1(kk+1)*vector(jj+1) + d2nb_1(kk+2)*vector(jj+2)
	  vectmp(ii+1) = vectmp(ii+1) + d2nb_1(kk+1)*vector(jj) +
     1	  	d2nb_1(kk+3)*vector(jj+1) + d2nb_1(kk+4)*vector(jj+2)
	  vectmp(ii+2) = vectmp(ii+2) + d2nb_1(kk+2)*vector(jj) +
     1	  	d2nb_1(kk+4)*vector(jj+1) + d2nb_1(kk+5)*vector(jj+2)
	  vectmp(jj) = vectmp(jj) + d2nb_1(kk)*vector(ii) +
     1	  	d2nb_1(kk+1)*vector(ii+1) + d2nb_1(kk+2)*vector(ii+2)
	  vectmp(jj+1) = vectmp(jj+1) + d2nb_1(kk+1)*vector(ii) +
     1	  	d2nb_1(kk+3)*vector(ii+1) + d2nb_1(kk+4)*vector(ii+2)
	  vectmp(jj+2) = vectmp(jj+2) + d2nb_1(kk+2)*vector(ii) +
     1	  	d2nb_1(kk+4)*vector(ii+1) + d2nb_1(kk+5)*vector(ii+2)
3	 continue
	 jbeg1 = jend1 + 1
	 ...
	 do 4 k=jbeg2,jend2
	  ...
	  ii = 3*(i-1)+1
	  jj = 3*(j-1)+1
	  vectmp(ii) = vectmp(ii) + d2nb_2(kk)*vector(jj) +
     1	  	d2nb_2(kk+1)*vector(jj+1) + d2nb_2(kk+2)*vector(jj+2)
	  vectmp(ii+1) = vectmp(ii+1) + d2nb_2(kk+1)*vector(jj) +
     1	  	d2nb_2(kk+3)*vector(jj+1) + d2nb_2(kk+4)*vector(jj+2)
	  vectmp(ii+2) = vectmp(ii+2) + d2nb_2(kk+2)*vector(jj) +
     1	  	d2nb_2(kk+4)*vector(jj+1) + d2nb_2(kk+5)*vector(jj+2)
	  vectmp(jj) = vectmp(jj) + d2nb_2(kk)*vector(ii) +
     1	  	d2nb_2(kk+1)*vector(ii+1) + d2nb_2(kk+2)*vector(ii+2)
	  vectmp(jj+1) = vectmp(jj+1) + d2nb_2(kk+1)*vector(ii) +
     1	  	d2nb_2(kk+3)*vector(ii+1) + d2nb_2(kk+4)*vector(ii+2)
	  vectmp(jj+2) = vectmp(jj+2) + d2nb_2(kk+2)*vector(ii) +
     1	  	d2nb_2(kk+4)*vector(ii+1) + d2nb_2(kk+5)*vector(ii+2)
4	 continue
	 jbeg2 = jend2 + 1
