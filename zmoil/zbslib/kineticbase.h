...
//		int fitFlag;
	...
	void updateTemperatureDependentRates( int eIndex, int mixstep, double *rates=0 );
...
struct KineticIntegrator {
	...
	// Full integration...
	int integrateD( double *icC, double *P, double endTime, double startTime=0.0, double stopIfStepSmallerThan=0.0 );
