...
void zuiMessageBox( char *title, char *msg, int colorError, char *okMsg, char *cancelMsg, char *okText, char *cancelText ) {
	...
	zuiNamedDialog( 0, "messageBoxText", title, 1, okMsg, cancelMsg, dlgParams[0] ? dlgParams : 0, ctlParams[0] ? ctlParams : 0, initMsg, okText, cancelText );
}
...
ZMSG_HANDLER( zuiMsgBoxInit ) {
	ZUI *z = ZUI::zuiFindByName( ZTmpStr( "%s/messageBoxText", zmsgS( dlgName ) ) );
...
ZMSG_HANDLER( zuiDialogOpen ) {
	ZUI *dlg = ZUI::zuiFindByName( "root/zuiDialog" );
