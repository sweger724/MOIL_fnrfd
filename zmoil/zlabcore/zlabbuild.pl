...
sub config_kin_demo {
	...
	if( $setup ) {
		...
		@configDefines = ( 'KIN', 'KIN_DEMO', "TITLE=\"KinTek Global Kinetic Explorer Student Version 3.0.$svnRev. Copyright Kenneth A. Johnson and KinTek Corporation\"" );
...
sub config_kin_pro {
	...
	if( $setup ) {
		...
		@configPlugins = ( 'kin' );
		$svnRev = svnRevision( $configPluginPaths{ '_kin' } ); 
		@configDefines = ( 'KIN', 'KIN_PRO', "TITLE=\"KinTek Global Kinetic Explorer Professional Version 3.0.$svnRev. Copyright Kenneth A. Johnson and KinTek Corporation\"" );
		$configIconWin32 = '../plug_kintek/_kin/kin.ico';
		$configIconMacosx = '../plug_kintek/_kin/kin.icns';
...
sub config_kin_dev {
	...
	if( $setup ) {
		...
		@configDefines = ( 'KIN' );
		$svnRev = svnRevision( $configPluginPaths{ '_kin' } ); 
		@configDefines = ( 'KIN', 'KIN_DEV', "TITLE=\"KinTek Global Kinetic Explorer DEV Version 3.0.$svnRev. Copyright Kenneth A. Johnson and KinTek Corporation\"" );
		$configIconWin32 = '../plug_kintek/_kin/kin.ico';
		$configIconMacosx = '../plug_kintek/_kin/kin.icns';
