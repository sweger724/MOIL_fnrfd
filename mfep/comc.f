...
c
 ...
 77         continue
 7          continue
            write(stdo,*)'normalization of grdcm[x,y,z] grdl[x,y,z]'
 ...
 90         continue
 9          continue
            write(stdo,*)'scalar products (should be zero) of:'
            write(stdo,*)'grdlx-grdcmx grdlx-grdcmy grdlx-grdcmz'
            if (orth) then
            write(stdo,*)'grdlx-grdp grdp-grdcmx'
            write(stdo,*)'grdp-grdcmy grdp-grdcmz'
            end if
            write(stdo,*)(test(i),i=1,ncc)
            end if
