...
#define         MAX_DENSITY	25 /* (was 15, 25) max no of atoms in a voxel(odd for algn) */

#define		MAX_CONSTRAINT 	5000 /* 700 */
#define		PERT_Q		5001 /* smallest prime exceeding MAX_CONSTRAINT*/
...
EXTERN int              torus_count_I;
EXTERN int              concave_count_I;
EXTERN int              convex_count_I;

EXTERN int              torus_count_III;
EXTERN int              convex_count_III;

EXTERN int              sphere_count_IV;

EXTERN int			atom1_bw;     // --bwang added for neighboring pair
EXTERN int			atom2_bw;
EXTERN int			faceid1_bw;
EXTERN int			faceid2_bw;
