...
c       vdw interactions are not modified 
        ...
        double precision qi,spi,rij,xerfc,erfc,erf,ovt,del,term
...
c = -f_ij, => f_ij = -df*rx
                        ...
                        virvdw3 = virvdw3 - (df1*rx*rx + df1*ry*ry 
     &                             + df1*rz*rz)
cc
                        rx = df*rx
                        ry = df*ry
...
c = -f_ij, => f_ij = -df*rx
                        ...
                        virvdw3 = virvdw3 - (df*rx*rx + df*ry*ry
     &                             + df*rz*rz)
cc
                      rx = df*rx
                      ry = df*ry
