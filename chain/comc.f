     ...
     1  nselec,grdcmx,grdcmy,grdcmz,grdlx,grdly,grdlz,dmass1,
     2  dmass2,x1,y1,z1,sigma,debug)
c
...
c
        ...
        double precision dmass(*),dmass1(*),dmass2(*),x1(*),y1(*),z1(*)
...
c
        if (debug) then
        write(*,*)' dmass2 ',(dmass2(j),j=1,nselec)
        do 61 i=1,6
                test(i)=0.d0
61      continue
        do 7 i=1,nsel3
...
8       continue
        do 9 i=1,nsel3
                ...
                test(4)=test(4)+grdlx(i)*grdly(i)*dmass2(j)
                test(5)=test(5)+grdlx(i)*grdlz(i)*dmass2(j)
                test(6)=test(6)+grdly(i)*grdlz(i)*dmass2(j)
9       continue
        write(*,*)'scalar products (should be zero) of:'
        write(*,*)'grdlx-grdcmx grdlx-grdcmy grdlx-grdcmz '
        write(*,*)'grdlx-grdly grdlx-grdlz grdly-grdlz '
        write(*,*)(test(i),i=1,6)
c@ some debug printing
        write(*,*)' grdcmx ',(grdcmx(i),i=1,3*nselec)
        write(*,*)' grdcmy ',(grdcmy(i),i=1,3*nselec)
        write(*,*)' grdcmz ',(grdcmz(i),i=1,3*nselec)
        write(*,*)' grdlx ',(grdlx(i),i=1,3*nselec)
        write(*,*)' grdly ',(grdly(i),i=1,3*nselec)
        write(*,*)' grdlz ',(grdlz(i),i=1,3*nselec)
        write(*,*) ' exiting comc '
        end if
