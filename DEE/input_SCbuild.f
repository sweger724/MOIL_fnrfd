      subroutine input_SCbuild(uwcrd,uwcon)
c
...
c...........read input lines
            do i=1,nposenh
               ...
               nmon = 1
#               
               read(stdi,1000) monatpos(1),rotindex
 1000          format(a4,1x,i6)
               write(stdo,1000) monatpos(1),rotindex
c
c
c..............find monomer type
               imono=1 
               do while ((monames4(imono).ne.monatpos(1)).and.
     &              (imono.le.totmons4))
                  imono=imono+1
               end do
               if (imono.gt.totmons4) then
                  if(monatpos(1).eq.'    ')then
