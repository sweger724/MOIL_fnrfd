...
c
                     call DEE_pairs0_innerloop(iA,iB,rotAreal,
...
c-------------------------------------------------------------------
c
      subroutine DEE_pairs0_innerloop(iA,iB,rotAreal,rotBreal,pointEijA,
