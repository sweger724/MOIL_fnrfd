...
C MASS IS NOT NECESSARY FOR STO. UNIFORM MASS IS USED. RE
...
c		write(*,*)' iterate k Mg = ',iterate,k,Mg
	      fac1 = ovrlx*Mg*mass1
	      fac2 = ovrlx*Mg*mass2
...
100       continue
c		write(*,*) ' in SHAKEPT: cooref '
c		do 2 k=1,nshak
c			write(*,*)(cooref(i,k),i=1,3)
c2		continue
c		write(*,*) ' in SHAKEPT: step '
c		do 3 k=1,npt
c			write(*,*)(velo(i,k),i=1,3)
c3		continue
c chen
...
c		write(*,*)' k iat1 iat2 iterate ',k,iat1,iat2,iterate
c		write(*,*)' SHAKPT: dr2 dissq ',dabs(r2),dissq(k)
c chen
